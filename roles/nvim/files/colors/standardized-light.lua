...
-- standardized-light scheme by ali
...
vim.api.nvim_set_hl(
    0,
    "Normal",
    { fg = gui05, bg = gui00, ctermfg = cterm05, ctermbg = cterm00 }
)
...
vim.api.nvim_set_hl(
    0,
    "Error",
    { fg = gui00, bg = gui08, ctermfg = cterm00, ctermbg = cterm08 }
)
vim.api.nvim_set_hl(
    0,
    "ErrorMsg",
    { fg = gui08, bg = gui00, ctermfg = cterm08, ctermbg = cterm00 }
)
vim.api.nvim_set_hl(0, "Exception", { fg = gui08, ctermfg = cterm08 })
vim.api.nvim_set_hl(
    0,
    "FoldColumn",
    { fg = gui0C, bg = gui01, ctermfg = cterm0C, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(
    0,
    "Folded",
    { fg = gui03, bg = gui01, ctermfg = cterm03, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(
    0,
    "IncSearch",
    { fg = gui01, bg = gui09, ctermfg = cterm01, ctermbg = cterm09 }
)
...
vim.api.nvim_set_hl(
    0,
    "Search",
    { fg = gui01, bg = gui0A, ctermfg = cterm01, ctermbg = cterm0A }
)
vim.api.nvim_set_hl(
    0,
    "Substitute",
...
vim.api.nvim_set_hl(
    0,
    "WildMenu",
    { fg = gui08, bg = gui0A, ctermfg = cterm08 }
)
vim.api.nvim_set_hl(0, "Title", { fg = gui0D, ctermfg = cterm0D })
vim.api.nvim_set_hl(
    0,
    "Conceal",
    { fg = gui0D, bg = gui00, ctermfg = cterm0D, ctermbg = cterm00 }
)
vim.api.nvim_set_hl(
    0,
    "Cursor",
    { fg = gui00, bg = gui05, ctermfg = cterm00, ctermbg = cterm05 }
)
...
vim.api.nvim_set_hl(
    0,
    "StatusLine",
    { fg = gui04, bg = gui02, ctermfg = cterm04, ctermbg = cterm02 }
)
vim.api.nvim_set_hl(
    0,
    "StatusLineNC",
...
vim.api.nvim_set_hl(
    0,
    "VertSplit",
    { fg = gui02, bg = gui02, ctermfg = cterm02, ctermbg = cterm02 }
)
...
vim.api.nvim_set_hl(
    0,
    "CursorLineNr",
    { fg = gui04, bg = gui01, ctermfg = cterm04, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(0, "QuickFixLine", { bg = gui01, ctermbg = cterm01 })
vim.api.nvim_set_hl(
    0,
    "PMenu",
    { fg = gui05, bg = gui01, ctermfg = cterm05, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(
    0,
    "PMenuSel",
    { fg = gui01, bg = gui05, ctermfg = cterm01, ctermbg = cterm05 }
)
vim.api.nvim_set_hl(
    0,
    "TabLine",
...
vim.api.nvim_set_hl(
    0,
    "TabLineSel",
    { fg = gui0B, bg = gui01, ctermfg = cterm0B, ctermbg = cterm01 }
)
...
vim.api.nvim_set_hl(
    0,
    "Todo",
    { fg = gui0A, bg = gui01, ctermfg = cterm0A, ctermbg = cterm01 }
)
...
vim.api.nvim_set_hl(
    0,
    "DiffDelete",
    { fg = gui08, bg = gui01, ctermfg = cterm08, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(
    0,
    "DiffText",
    { fg = gui0D, bg = gui01, ctermfg = cterm0D, ctermbg = cterm01 }
)
vim.api.nvim_set_hl(
    0,
    "DiffAdded",
    { fg = gui0B, bg = gui00, ctermfg = cterm0B, ctermbg = cterm00 }
)
vim.api.nvim_set_hl(
    0,
    "DiffFile",
...
vim.api.nvim_set_hl(
    ...
    { fg = gui0E, bg = gui01, ctermfg = cterm0E, ctermbg = cterm01 }
)
...
vim.api.nvim_set_hl(
    0,
    "LspDiagnosticsDefaultHnformation",
